...
/*
 * INITIALSTATE: No cards have been processed yet.
 * SUCCESSSTATE: Card has been processed and succeeded.
 * FAILEDSTATE:  Card has been processed but failed.
 */
const INITIALSTATE = "INITIAL", SUCCESSSTATE = "COMPLETE", FAILEDSTATE = "FAILED";

// CreditCardForm component for building credit card input form
class CreditCardForm extends React.Component {
  ...
  renderCreditCardInformation() {
    ...
    if (user.loggedin === true) {
      remembercardcheck = <div className="form-row form-check text-center">
        ...
        <label className="form-check-label" htmlFor="remembercardcheck">Remember Card?</label>
      </div>;
    }
    return (
      <div>
  ...
  // For credit card information has been sent to Stripe successfully
  renderSuccess() {
    return (
      <div>
  ...
  // For credit card information has not been sent to Stripe successfully
  renderFailure() {
    return (
      <div>
  ...
  // Submit a credit card token to the backend
...
export default function CreditCardInformation(props) {
  ...
  const CCFormWithStripe = injectStripe(CreditCardForm);    // Inject our CreditCardForm component with the Stripe API code.
  return (
    <div>
